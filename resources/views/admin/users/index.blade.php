                        ...
                        <td>
                            <div class="flex justify-between items-center gap-2">
                                <a class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#editUserModal{{ $user->id }}">Editar</a>
                                <a class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#modal{{ $user->id }}">Cambiar Estado</a>
                            </div>
                        </td>
                    </tr>
                    <!-- MODAL ELIMINAR -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ¿Está seguro que desea cambiar la disponibilidad al usuario
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{ route('users.update', [$user->id]) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control mb-2" name="documento" id="documento"
                                                placeholder="Escriba el documento..." value="{{ $user->documento }}"
                                                required>
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control mb-2" name="telefono"
                                                id="telefono" placeholder="Escriba el teléfono..."
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control mb-2" name="telefono2"
                                                id="telefono2" placeholder="Escriba el teléfono..."
                                                value="{{ $user->telefono2 }}" required>
                                            <div class="invalid-feedback">
                                                Complete este campo.
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control mb-2" name="email"
                                                id="email" placeholder="Escriba el contenido..."
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email2" class="form-control mb-2" name="email2"
                                                id="email2" placeholder="Escriba el contenido..."
                                                value="{{ $user->email2 }}" required>
                                            <div class="invalid-feedback">
                                                Por favor, ingrese un correo electrónico.
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch my-2">
                                                <label class="form-check-label" for="disponibilidad">Disponibilidad
                                                </label>
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    id="disponibilidad" name="disponibilidad"
                                                    {{ $user->disponibilidad ? 'checked' : '' }}>
                                            </div>
                                        </div>
                ...
                <div class="modal-body">
                    <form action="{{ route('users.store') }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3 row g-3">
                            ...
                            <div class="col-6">
                                <label for="apellido" class="form-label">Apellido</label>
                                <input type="text" placeholder="Escriba el apellido..." class="form-control"
                        ...
                        <div class="mb-3">
                            <label for="documento" class="form-label">Documento *</label>
                            <input type="text" placeholder="Escriba el documento..." class="form-control"
                        ...
                        <div class="mb-3">
                            <label for="telefono" class="form-label">Teléfono *</label>
                            <input type="text" placeholder="Escriba el telefono..." class="form-control"
                        ...
                        <div class="mb-3">
                            <label for="telefono2" class="form-label">Teléfono 2 *</label>
                            <input type="text" placeholder="Escriba el telefono..." class="form-control"
                                id="telefono2" name="telefono2" required>
                            <div class="invalid-feedback">
                                Complete este campo.
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="email" class="form-label">Email *</label>
                            <input type="email" placeholder="Escriba el email..." class="form-control" id="email"
                                name="email" required>
                            <div class="invalid-feedback">
                                Por favor, ingrese un correo electrónico
                            </div>
                        ...
                        <div class="mb-3">
                            <label for="email2" class="form-label">Email 2 *</label>
                            <input type="email" placeholder="Escriba el email..." class="form-control" id="email2"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" placeholder="Escriba el password..." class="form-control"
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch my-2">
                                ...
                                <input class="form-check-input" type="checkbox" role="switch" id="disponibilidad"
